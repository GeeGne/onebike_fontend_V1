  ...
  const handleFocus = e => {
    ...
    switch (name) {
      case 'tel':
        ...
        telLabelEL.current.style.color = 'var(--font-p-color)';
        break;
      case 'password':
        ...
        passLabelEL.current.style.color = 'var(--font-p-color)';
      break;
      default:
    ...
    if (inputEmpty) {
      switch (name) {
        case 'tel':
          ...
          telLabelEL.current.style.fontWeight = '550';
          telLabelEL.current.style.color = 'var(--font-h-color)';
          break;
        case 'password':
          passLabelEL.current.style.top = '50%';
          passLabelEL.current.style.fontSize = 'var(--font-size-small)';
          passLabelEL.current.style.fontWeight = '550';
          passLabelEL.current.style.color = 'var(--font-h-color)';
          break;
        default:
          console.log('Unknown type:', type);
      }
